			...
			<table class="table table-striped table-bordered">
				<tbody>
					...
					<tr>
						...
						</a> <a href='memberEdit.jsp?memId=${memberVO.memId}' class="btn btn-info btn-sm"> <span class="glyphicon glyphicon-king" aria-hidden="true"></span> &nbsp;수정
						</a></td>
					</tr>
				</tbody>
			</table>
